DELIVERY LETTER FOR THE DRAFT ARTICLE AUTHORING DTD 
           (Authoring (Pumpkin) Version 2.3 February 2, 2007)
...
This README describes:
   ...
   1.0 Files in This Delivery
       1.1  Catalog Files
       1.2  Modules Specific to the NLM Article Authoring DTD
...
1.8 Sample files for testing Authoring (Pumpkin)
