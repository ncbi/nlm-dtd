...
1. syncROsoft oXygen (version 7.1; using Xerces)
...
where the xsi:noNamespaceSchemaLocation attribute points to the archivearticle.xsd module on the system, and the settings appear on the root element of your document (which may or may not be <article>).
