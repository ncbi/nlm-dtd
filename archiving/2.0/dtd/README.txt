README.TXT                           20 December, 2004

This README names the modules delivered as Version 2.0 
of the NLM Journal Archiving DTD and Version 2.0
and the 2.0 version of the NLM Archiving and Interchange 
DTD Suite.

A file named GreenChangesV2.html describes the major
...
The rest of this README contains notes concerning:
  1.0 Catalog File
  2.0 Modules Specific to the NLM Journal Archiving DTD
...
In versions 1.0 and 1.1 of the NLM Journal Archiving DTD,
all class definitions, mix definitions, and DTD-over-rides
were done in a single module, named archivecustomize.ent.
...
samplesmall-green.xml - Minimal Archival DTD document used to 
                        test the DTD
