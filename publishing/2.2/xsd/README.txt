...
mathml2/mathml2.xsd   [mathml namespace: 
...
where the xsi:noNamespaceSchemaLocation attribute points to the journalpublishing.xsd module on the system, and the settings appear on the root element of your document (which may or may not be <article>).
